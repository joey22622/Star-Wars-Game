...
$("body").on("click", ".character", assignPlayer);
$("body").on("click", ".character", assignDefender);
//$("body").on("click", ".character", assignChar(player));
...
function loadCharBank(){
    ...
    for(var i = 0; i < remBank.length; i++){
        ...
        char.attr({"data-character" : j , "class" : "character character-" +(j)});
        imgWrap.append(img);
...
// function assignChar(character) {
//     var charString = ".player";
//     var i = $(this).attr('data-character');
//     var img = $(charString + "-wrap .image-wrap img");
//     var name = $(charString + "-wrap .name");
//     var hp = $(charString + "-wrap .hp");
//     var attack = $(charString + "-wrap .attack");
//     var counter = $(charString + "-wrap .counter");
//     character = remBank[i];
//     img.attr("src" , "assets/images/character-" + i + ".jpg");
//     console.log("name " + );
//     // name.text(character.name);
//     // hp.text(character.hp);
//     // attack.text(character.baseAttack);
//     // counter.text(character.counter);
// }
